...
"vendor_ontime": {
    ...
    "charts": [
    {
        ...
        "x": "Bucket",
        "y": "Vendor Count",
        "title": "Numbers of Vendors by PO Completion Rate"
    }
]
},
    ...
    "order_delivery": {
        ...
        "charts": [
        {
            ...
            "title": "On-Time(<=15 Days) vs Delayed Deliveries(>15 Days)"
        },
        {
            "type": "stacked_bar",
            "x": "Month",
        ...
        "charts": [
            {
                "type": "donut",
                "column": "Status",
                "title": "Transfer Order Status Distribution"
            },
            {
                "type": "stacked_bar",
                "x": "Month",
...
"cost_optimization": {
    ...
    "column": "Stock_Status",
    "value": "Count",
    "title": "PM Stock Health Distribution",
    "colors": {
                "RED": "#e74c3c",
                "YELLOW": "#f1c40f",
                "GREEN": "#2ecc71"
    ...
    "x": "SLA Bucket",
    "y": "SLA %",
    "title": "SO to Shipment Creation Buckets"
}
